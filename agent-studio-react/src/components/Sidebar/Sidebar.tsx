...
const navItems: { id: PageId; label: string; badge?: string; icon: React.ReactNode }[] = [
  ...
  { id: 'projects', label: '项目', badge: 'Beta', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg> },
